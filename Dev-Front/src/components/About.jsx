        ...
        <div className="lg:w-1/2 w-full md:w-3/4 px-10 md:p-0">
          <div data-aos="fade-left">
            ...
            <p className="text-lg mt-5 text-gray-600 primary-font text-justify ">
              At AdsAdapt India, we are not just a digital marketing agency – we are your dedicated growth partner. Founded with a passion for helping businesses adapt to the fast-evolving digital world, our mission is simple yet powerful: To drive real results, not just reach. <br /><br />

              With a strong foundation in data-driven strategies, creative storytelling, and performance-focused campaigns, AdsAdapt India has emerged as one of the most trusted names in the digital advertising space. We cater to a diverse range of industries, from startups and small businesses to large enterprises, offering tailored marketing solutions that deliver measurable success.
            </p>
