  ...
  return (
    <div data-aos="fade-down" className="text-[#7A6960]">
      <h1 className="text-3xl font-semibold text-center">
              Stay Updated with Our Digital Marketing Tips!
      ...
      <p className="text-gray-700 text-center mt-7 mb-10 p-3 md:p-0">
       Subscribe now and get the latest updates, offers, and expert tips on SEO, Web Development, Social Media Marketing, and more.
      </p>
